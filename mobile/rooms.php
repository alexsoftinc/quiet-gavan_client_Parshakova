...
<div class="order_holder">
	<div class="order_area">
		<div class="button" style="color: white;">
			<a style="color: white; text-decoration: none;" href="tel:89824995959">ПОЗВОНИТЬ</a>
		</div>
...
<h2>Тематические номера: MoDaMo, ЯГУАР, VIOLETTA, D O N N A, хуторок, гейша, Клеопатра, Texas, КАРМЕН, чердак.........</h2>
...
<tbody>
	<tr>
		<td>
			<div>
				<div class="sticker">MoDaMo час | ночь | сутки |<br/> 
					<font style="padding-left: 58px;">250 | 1000 | 1500 руб.</font>
				</div>
				<img src="images/rooms/1.jpg"><br/>
			</div>
		</td>
	</tr>
	...
	<tr>
		<td>
			<div style="margin-top: -50px;">
				<div class="sticker">ЯГУАР час | ночь | сутки |<br/> 
					<font style="padding-left: 58px;">250 | 1000 | 1500 руб.</font>
				</div>
				<img src="images/rooms/2.jpg"><br/>
			</div>
		</td>
	</tr>
	...
	<tr>
		<td>
			<div style="margin-top: -50px;">
				<div class="sticker">V I O L E T T A час | ночь | сутки |<br/> 
					<font style="padding-left: 98px;">250 | 1000 | 1500 руб.</font>
				</div>
				<img src="images/rooms/3.jpg"><br/>
			</div>
		</td>
	</tr>	
	...
	<tr>
		<td>
			<div style="margin-top: -50px;">
				<div class="sticker">D O N N A час | ночь | сутки |<br/> 
					<font style="padding-left: 58px;">250 | 1000 | 1500 руб.</font>
				</div>
				<img src="images/rooms/4_1.jpg"><br/>
			</div>
		</td>
	</tr>	
