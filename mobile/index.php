...
{ 
echo 'Test Site Version !';
} 
else 
{
header('Location: http://xn--------3vebabrj6a1ak3a9aidtywmeiqz2b2df6lil5e.xn--p1ai/');
}
?>
<html>
<head>
...
<param name=movie value="player/niftyplayer.swf?file=player/1.mp3&as=1">
<param name=quality value=high>
<param name=bgcolor value=#FFFFFF>
<embed src="player/niftyplayer.swf?file=player/1.mp3&as=1" quality=high bgcolor=#FFFFFF width="165" height="38" name="niftyPlayer1" align="" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer">
</embed>
</object>
</section>
<br/><br/>
...
<div class="menu_hidden">
	<ul>
		...
		<li><a href="reservation.php"><img src="images/calendar.png"><span style="font-size: 30px; font-weight: bold;">Забронировать</span></a></li>
