...
if(is_mobile() == 0 AND substr_count($_SERVER['HTTP_USER_AGENT'], 'android') > 0)
echo header('Location: http://mobile.xn--------3vebabrj6a1ak3a9aidtywmeiqz2b2df6lil5e.xn--p1ai/'); //может быть и планшет.- но с 90% труба
elseif(is_mobile() == 0 AND substr_count($_SERVER['HTTP_USER_AGENT'], 'android') == 0)
echo 'Компьютер';
elseif(in_array(is_mobile(), array(1,2,3,4)))echo header('Location: http://mobile.xn--------3vebabrj6a1ak3a9aidtywmeiqz2b2df6lil5e.xn--p1ai/'); //может быть и планшет.- но с 90% труба
